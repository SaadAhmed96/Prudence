...
<View style={{flex:1}}>
      ...
      <ScrollView style={styles.parent}>
       <Image style={{height:200,width:290,alignSelf:'center',marginBottom:10}} source={require('./../assets/images/agree.png')}/>
          {/* <Text style={{fontWeight:'bold',fontSize:17,marginBottom:20}}>License and Agreement </Text> */}
            <Text>
            PRIVACY POLICY
...
Thank you for choosing to be part of our community at Covid QRT. We are committed to protecting your personal information and your right to privacy. If you have any questions or concerns about our policy, or our practices with regards to your personal information, please contact us at info@corona-tracking.com.
...
Publicly Available Personal Information. We collect first name, maiden name, last name, and nickname; phone numbers; email addresses; family member names and their related information; and other similar data. 

Personal Information Provided by You. We collect data about health, DNA, medical records, FitBit, and similar apps; data held by a hospital or doctor; and other similar data.
...
If you use our Apps, we may also collect the following information:
    ...
    Mobile Device Access. We may request access or permission to certain features from your mobile device, including your mobile device's bluetooth, sensors, storage, and other features. If you wish to change our access or permissions, you may do so in your device's settings.
...
If you have questions or comments about this policy, you may email us at info@corona-tracking.com or by post to:
https://corona-tracking.com 
Business Arcade
Shahra e Faisal, Sindh 75100
Pakistan


HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?
Based on the laws of some countries, you may have the right to request access to the personal information we collect from you, change that information, or delete it in some circumstances. To request to review, update, or delete your personal information, please visit: https://corona-tracking.com. We will respond to your request within 30 days.
This privacy policy was created using Termly’s Privacy Policy Generator.
            </Text>
     <Text style={{marginTop:10}}>I agree with your <Text style={{color:"#4F5EE8"}}>Privacy Policy</Text></Text>
     <TouchableOpacity onPress={this.Login} style={{alignSelf:'center', height: 40, justifyContent: 'center', borderRadius:25, paddingHorizontal:30,}} >
              <Text style={{color: '#4F5EE8', fontSize: 18,fontWeight:'bold'}}>Agree</Text>
      </TouchableOpacity>
     <TouchableOpacity   style={{alignSelf:'center', height: 40, justifyContent: 'center', borderRadius:25, paddingHorizontal:30,marginBottom:50}} >
              <Text style={{color: 'red', fontSize: 18,fontWeight:'bold'}}>Decline</Text>
      </TouchableOpacity>
     </ScrollView>
